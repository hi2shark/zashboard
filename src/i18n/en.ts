const en = {
  ...
  adaptiveTargetFilter: 'Filter target',
  adaptiveNodeFilter: 'Filter node',
  adaptiveLive: 'Live',
  adaptiveConnecting: 'Connecting',
  adaptiveGroups: 'Groups',
  adaptiveProbe: 'Probe',
  adaptiveProbeRunning: 'Running',
  adaptiveProbeIdle: 'Idle',
  adaptiveTargetScope: 'Scope',
  adaptiveGeneratedAt: 'Generated',
  adaptiveConfig: 'Config',
  adaptiveTcpSuccess: 'TCP success',
  adaptiveTcpFailure: 'TCP failure',
  adaptiveRetry: 'Retries',
  adaptiveProbeSuccess: 'Probe success',
  adaptiveProbeFailure: 'Probe failure',
  adaptiveEjections: 'Ejections',
  adaptiveNodes: 'nodes',
  adaptiveNode: 'Node',
  adaptiveState: 'State',
  adaptiveEffectiveWeight: 'Effective weight',
  adaptiveSlowStart: 'Slow-start',
  adaptiveSuccessRate: 'Success rate',
  adaptiveLatency: 'Latency',
  adaptiveLatencyBasis: 'Latency basis',
  adaptiveProbeLatency: 'Probe latency',
  adaptiveDialLatency: 'Dial latency',
  adaptiveProbeUrl: 'Probe URL',
  adaptiveProbeExpectedStatus: 'Expected status',
  adaptiveLatencyFactor: 'Latency factor',
  adaptiveFailures: 'Failures',
  adaptiveActiveConns: 'Active',
  adaptiveLastError: 'Last error',
  adaptiveObservedTargets: 'Observed targets',
  adaptiveProbeIneligible: 'no probe',
  adaptiveWaiting: 'Waiting for adaptive metrics…',
  adaptiveColdStart: 'Targets observed, waiting for first dial samples…',
