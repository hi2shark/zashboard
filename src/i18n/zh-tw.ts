...
const zhTW: LANG_MESSAGE = {
  ...
  adaptiveTargetFilter: '過濾目標',
  adaptiveNodeFilter: '過濾節點',
  adaptiveLive: '即時',
  adaptiveConnecting: '連線中',
  adaptiveGroups: '分組',
  adaptiveProbe: '探測',
  adaptiveProbeRunning: '執行中',
  adaptiveProbeIdle: '未啟動',
  adaptiveTargetScope: '作用域',
  adaptiveGeneratedAt: '產生時間',
  adaptiveConfig: '設定',
  adaptiveTcpSuccess: 'TCP 成功',
  adaptiveTcpFailure: 'TCP 失敗',
  adaptiveRetry: '重試',
  adaptiveProbeSuccess: '探測成功',
  adaptiveProbeFailure: '探測失敗',
  adaptiveEjections: '熔斷',
  adaptiveNodes: '節點',
  adaptiveNode: '節點',
  adaptiveState: '狀態',
  adaptiveEffectiveWeight: '有效權重',
  adaptiveSlowStart: '慢啟動',
  adaptiveSuccessRate: '成功率',
  adaptiveLatency: '延遲',
  adaptiveLatencyBasis: '延遲尺',
  adaptiveProbeLatency: '探測延遲',
  adaptiveDialLatency: '業務延遲',
  adaptiveProbeUrl: '探測 URL',
  adaptiveProbeExpectedStatus: '期望狀態',
  adaptiveLatencyFactor: '延遲因子',
  adaptiveFailures: '連續失敗',
  adaptiveActiveConns: '活躍連線',
  adaptiveLastError: '最近錯誤',
  adaptiveObservedTargets: '已發現目標',
  adaptiveProbeIneligible: '不探測',
  adaptiveWaiting: '等待自適應指標…',
  adaptiveColdStart: '已發現目標，等待首次撥號樣本…',
  adaptiveStateNormal: '正常',
  adaptiveStateRecovering: '恢復中',
  adaptiveStateEjected: '熔斷',
  adaptiveStateHalfOpen: '半開',
}
