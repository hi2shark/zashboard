...
const zh: LANG_MESSAGE = {
  ...
  adaptiveTargetFilter: '过滤目标',
  adaptiveNodeFilter: '过滤节点',
  adaptiveLive: '实时',
  adaptiveConnecting: '连接中',
  adaptiveGroups: '分组',
  adaptiveProbe: '探测',
  adaptiveProbeRunning: '运行中',
  adaptiveProbeIdle: '未启动',
  adaptiveTargetScope: '作用域',
  adaptiveGeneratedAt: '生成时间',
  adaptiveConfig: '配置',
  adaptiveTcpSuccess: 'TCP 成功',
  adaptiveTcpFailure: 'TCP 失败',
  adaptiveRetry: '重试',
  adaptiveProbeSuccess: '探测成功',
  adaptiveProbeFailure: '探测失败',
  adaptiveEjections: '熔断',
  adaptiveNodes: '节点',
  adaptiveNode: '节点',
  adaptiveState: '状态',
  adaptiveEffectiveWeight: '有效权重',
  adaptiveSlowStart: '慢启动',
  adaptiveSuccessRate: '成功率',
  adaptiveLatency: '延迟',
  adaptiveLatencyBasis: '延迟尺',
  adaptiveProbeLatency: '探测延迟',
  adaptiveDialLatency: '业务延迟',
  adaptiveProbeUrl: '探测 URL',
  adaptiveProbeExpectedStatus: '期望状态',
  adaptiveLatencyFactor: '延迟因子',
  adaptiveFailures: '连续失败',
  adaptiveActiveConns: '活跃连接',
  adaptiveLastError: '最近错误',
  adaptiveObservedTargets: '已发现目标',
  adaptiveProbeIneligible: '不探测',
  adaptiveWaiting: '等待自适应指标…',
  adaptiveColdStart: '已发现目标，等待首次拨号样本…',
  adaptiveStateNormal: '正常',
  adaptiveStateRecovering: '恢复中',
  adaptiveStateEjected: '熔断',
  adaptiveStateHalfOpen: '半开',
}
