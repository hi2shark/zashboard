...
const ru: LANG_MESSAGE = {
  ...
  // Adaptive weighted observation
  adaptiveTargetFilter: 'Фильтр цели',
  adaptiveNodeFilter: 'Фильтр узла',
  adaptiveLive: 'Онлайн',
  adaptiveConnecting: 'Подключение',
  adaptiveGroups: 'Группы',
  adaptiveProbe: 'Проба',
  adaptiveProbeRunning: 'Работает',
  adaptiveProbeIdle: 'Ожидание',
  adaptiveTargetScope: 'Область',
  adaptiveGeneratedAt: 'Создано',
  adaptiveConfig: 'Конфиг',
  adaptiveTcpSuccess: 'TCP успех',
  adaptiveTcpFailure: 'TCP сбой',
  adaptiveRetry: 'Повторы',
  adaptiveProbeSuccess: 'Проба успех',
  adaptiveProbeFailure: 'Проба сбой',
  adaptiveEjections: 'Отключения',
  adaptiveNodes: 'узлов',
  adaptiveNode: 'Узел',
  adaptiveState: 'Состояние',
  adaptiveEffectiveWeight: 'Эфф. вес',
  adaptiveSlowStart: 'Slow-start',
  adaptiveSuccessRate: 'Успех',
  adaptiveLatency: 'Задержка',
  adaptiveLatencyBasis: 'База задержки',
  adaptiveProbeLatency: 'Проба',
  adaptiveDialLatency: 'Dial',
  adaptiveProbeUrl: 'URL пробы',
  adaptiveProbeExpectedStatus: 'Ожидаемый статус',
  adaptiveLatencyFactor: 'Фактор задержки',
  adaptiveFailures: 'Сбои',
  adaptiveActiveConns: 'Активные',
  adaptiveLastError: 'Последняя ошибка',
  adaptiveObservedTargets: 'Наблюдаемые цели',
  adaptiveProbeIneligible: 'без пробы',
  adaptiveWaiting: 'Ожидание метрик adaptive…',
  adaptiveColdStart: 'Цели обнаружены, ждем первые dial-сэмплы…',
  adaptiveStateNormal: 'normal',
  adaptiveStateRecovering: 'recovering',
  adaptiveStateEjected: 'ejected',
  adaptiveStateHalfOpen: 'half-open',
}
